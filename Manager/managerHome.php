...
<table align="center">
 <tr>
  ...
  <td><button  onclick="window.location.href='couponSearchBoundary.php'">Coupons</button></td>
  <td><button onclick="window.location.href='managerViewMenuBoundary.php'">Menu</button></td>
 </tr>
<table> 
